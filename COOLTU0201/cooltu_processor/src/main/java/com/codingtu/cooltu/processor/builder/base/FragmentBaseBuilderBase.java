...
public abstract class FragmentBaseBuilderBase extends com.codingtu.cooltu.processor.builder.core.CoreBuilder {
    ...
    protected StringBuilder getViewMethods;
    ...
    protected com.codingtu.cooltu.lib4j.data.map.ListValueMap<String, String> onDestroy;
    ...
    public FragmentBaseBuilderBase(com.codingtu.cooltu.lib4j.data.java.JavaInfo info) {
        ...
        getViewMethods = map.get("getViewMethods");
        ...
        onDestroy = new com.codingtu.cooltu.lib4j.data.map.ListValueMap<>();
    ...
    public void onDestroyIf(String onDestroy) {
        addForMap(this.onDestroy, getIfKey("onDestroy"), onDestroy);
        onDestroyIfs.put(getIfKey("onDestroy"), true);
    }
    ...
    protected void dealLinesInParent() {
        ...
        if (isIf(onDestroyIfs, getIfKey("onDestroy"))) {
            List<String> onDestroy0 = onDestroy.get(getIfKey("onDestroy"));
            addLnTag(onDestroySb, "[onDestroy]", onDestroy0.get(0));
        }
    ...
    protected List<String> getTempLines() {
        ...
        lines.add("");
        lines.add("public abstract class [[name]] extends [[baseClass]] implements View.OnClickListener, View.OnLongClickListener, [[netBackIFullName]][[msThreadInterface]]{");
        lines.add("[[field]]");
